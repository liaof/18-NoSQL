...
request.onsuccess = function( event ) {
    ...
    // check if app is online (connected to the internet network), if yes run uploadPizza() function to send all local db data to api
    if ( navigator.online ) {
...
function saveRecord( record ) {
    ...
    // add data to 'new_pizza' object store
...
function uploadPizza() {
    ...
    console.log('Pizza loaded from IndexedDB');
};

/// listen for app coming back online, ie after internet reset
